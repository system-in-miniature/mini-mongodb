...
REPO_URL = "https://github.com/system-in-miniature/mini-mongodb"
META = re.compile(
...
def role_rank(path: str) -> int:
    if path.startswith(("src/minimongodb/index/", "src/minimongodb/storage/")):
        return 0
    if path.startswith("src/minimongodb/"):
        return 1
...
def render_index(cards: list[Card], *, chinese: bool) -> str:
    if chinese:
        ...
        lines = [
            ...
            "",
            "This is the browser-based path among MiniMongoDB's three learning modes. Use the [Mechanism Tutorial](../index.md) for topic-oriented study, or the [Agent-Guided usage guide](../agent-guide.md) for interactive CLI teaching.",
            "",
            "For an editor-focused diff, run `python -m journey.tools.build_journey study N` and open `../MiniMongoDB-journey-workspace`.",
            "",
    ...
    for card in cards:
        ...
        chapter_link = (
            ...
            + {
                ...
                2: "02-document-model.md",
                3: "03-queries.md",
                4: "04-updates.md",
                5: "05-durability.md",
                6: "06-oplog.md",
                7: "07-secondary-indexes.md",
                8: "08-planner-explain.md",
                9: "09-aggregation.md",
                10: "10-relational-vs-document.md",
            }[card.chapter]
        )
        lines.append(
