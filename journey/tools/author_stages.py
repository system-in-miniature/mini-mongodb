#!/usr/bin/env python3
"""Materialize the reviewed bilingual MiniMongoDB Stage lessons and layouts."""
...
CHAPTER_SLUGS = {
    ...
    5: "05-durability",
    6: "06-oplog",
    7: "07-secondary-indexes",
    8: "08-planner-explain",
    9: "09-aggregation",
    10: "10-relational-vs-document",
}
...
[第 {chapter} 章](https://github.com/system-in-miniature/mini-mongodb/blob/main/docs/zh/tutorial/{CHAPTER_SLUGS[chapter]}.md)"""
    return f"""### Goal
...
[Chapter {chapter}](https://github.com/system-in-miniature/mini-mongodb/blob/main/docs/tutorial/{CHAPTER_SLUGS[chapter]}.md)"""
...
def main() -> int:
    ...
    if len(manifest.stages) != len(FACTS):
        raise ValueError("lesson facts must match the eight-Stage manifest")
    ...
    print("wrote 8 bilingual MiniMongoDB goals and layouts")
    return 0
