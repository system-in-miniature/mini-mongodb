# Stage 06 · Indexed plans and aggregation pipelines
...
??? note "File diff: tests/test_aggregate.py"
    ```diff
...
??? note "File diff: tests/test_indexes.py"
    ```diff
...
??? note "File diff: tests/test_planner.py"
    ```diff
...
??? note "File diff: src/minimongodb/aggregate/__init__.py"
    ```diff
...
??? note "File diff: src/minimongodb/database.py"
    ```diff
...
??? note "File diff: src/minimongodb/index/secondary.py"
    ```diff
...
??? note "File diff: src/minimongodb/plan/__init__.py"
    ```diff
