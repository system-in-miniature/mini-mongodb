...
Use this mode when you want Codex to guide one MiniMongoDB Stage interactively in
the terminal.

## 1. Open Codex in MiniMongoDB
...
Replace `03` with any Stage from `01` through `08`. Codex prepares the correct
